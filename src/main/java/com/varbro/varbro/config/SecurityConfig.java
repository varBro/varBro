...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers("/logistics/manager/**", "/logistics/order/*/**").not().access("hasRole('ROLE_LOGISTICS') and hasRole('MANAGER')")
                .antMatchers("/logistics/**").hasAuthority("ROLE_LOGISTICS")
                .antMatchers("/logistics/manager/**", "/logistics/order/*/**").access("hasRole('ROLE_LOGISTICS') and not hasRole('MANAGER')")
