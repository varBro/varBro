...
public class DbInit implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        Beer Pils = new Beer("Pils");
        Beer Ipa = new Beer("Ipa");

        Pils.setIngredients(new HashSet(Arrays.asList(HOPS, YEAST)));
        Ipa.setIngredients(new HashSet(Arrays.asList(HOPS, YEAST)));

        List<Beer> beers = Arrays.asList(Pils,Ipa);
